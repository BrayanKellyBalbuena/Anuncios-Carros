					...
					<div class = "container-fluid">
						...
						<div class="navbar-collapse collapse navbar-responsive-collapse">
							<ul class="nav navbar-nav navbar-right">
								...
								<li><a class = "btn btn-flat btn-white" href = "usuario_registro.php">Registrarte</a></li>
								<li><a class = "btn btn-flat btn-white" href = "login.php">Login</a></li>
								<?php
									if (isset($_SESSION['usrAdmin'])){
									echo"<li><a class='btn btn-flat btn-material-teal-900' href = \"logout.php\">Salir</a></li>";
									}
								?>
							</ul>
						</div> <!--end div collapse-->
					</div>	 <!--end  div conten-fluid-->
				</nav>
